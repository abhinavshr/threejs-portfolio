    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 xl:px-20 relative z-10 w-full mb-16">
            ...
            >
                ...
                <div className="w-20 md:w-24 h-1.5 bg-linear-to-r from-blue-500 to-purple-500 mx-auto rounded-full" />
            </motion.div>
        </div>
                ...
                {SOFT_SKILLS.length > 0 ? (
                    SOFT_SKILLS.map((skill, index) => (
                        ...
                        >
                            ...
                            <div className="bg-slate-200 dark:bg-slate-800/80 p-5 rounded-2xl mb-5 shadow-inner relative z-10 transition-transform duration-300 group-hover:-translate-y-2 group-hover:bg-slate-200 dark:group-hover:bg-slate-800 ring-1 ring-slate-700">
                                {skill.icon}
                            </div>
                            ...
                            */}
                            <div className="relative z-10 md:max-h-0 md:opacity-0 group-hover:max-h-60 group-hover:opacity-100 transition-all duration-500 ease-in-out md:overflow-hidden text-slate-600 dark:text-slate-400 text-sm md:text-base leading-relaxed md:mt-0 group-hover:mt-4">
                                <p className="pt-4 md:pt-0 border-t border-slate-200 dark:border-slate-800 md:border-transparent group-hover:border-slate-200 transition-colors duration-300">
                                    {skill.description}
                                </p>
                            </div>
                        </motion.div>
