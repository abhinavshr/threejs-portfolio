        ...
        <footer className="relative w-full bg-slate-950 pt-16 md:pt-20 pb-10 overflow-hidden border-t border-slate-900">
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 xl:px-20 relative z-10">
                    ...
                    <div className="flex flex-col space-y-6">
                        ...
                        >
                            <p className="text-slate-400 text-sm md:text-base leading-relaxed">
                                This section reinforces my dedication to <span className="text-indigo-400">continuous learning</span>,
                                <span className="text-indigo-400"> clean architecture</span>, and <span className="text-indigo-400"> user-focused development</span>.
                ...
                <div className="pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    >
                        © 2025 <span className="text-slate-300 font-medium">Abhinav Shrestha</span>. All rights reserved. <br className="sm:hidden" />
