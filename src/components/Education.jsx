            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 xl:px-20 relative z-10 w-full mb-16">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-6 text-white">
                        Academic <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-500">Journey</span>
                    </h2>
                        ...
                        >
                            ...
                            <div className={`flex-1 bg-slate-900/60 backdrop-blur-md border border-slate-800 rounded-2xl p-6 md:p-8 hover:border-${edu.color}-500/30 transition-all shadow-lg relative overflow-hidden group-hover:shadow-[0_10px_30px_-15px_rgba(99,102,241,0.2)] w-full`}>
                                ...
                                <div className="flex items-start justify-between mb-4 flex-col sm:flex-row sm:items-center gap-4">
                                    <div>
                                        <span className={`text-${edu.color}-400 font-bold tracking-wider uppercase text-xs md:text-sm mb-2 block`}>
                                            {edu.highlight}
                                        </span>
